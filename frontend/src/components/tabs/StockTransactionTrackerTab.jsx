...
const TransactionTrackerTab = () => {
  const {
    filters,
    setFilters,
    fetchStockTransactionTracker,
    reports,
    loading,
    error,
    clearFilters,
  ...
  const handleDownloadPDF = () => {
    generatePDF("stock-transaction-tracker");
  };
  ...
  return (
    <div>
      ...
      {/* Data Table */}
      <DataTable
        data={reports.stockTransactionTracker || []}
        loading={loading}
        error={error}
      />
    </div>
...
export default TransactionTrackerTab;
